...
const Contact = () => {
  ...
  //'service_etl0168', 'template_ct5yeab', form.current, 'f7eq1uANvoLBxo-4H
  ...
  const handleSubmit = (e)=>{
    ...
    emailjs.send('service_etl0168','template_ct5yeab',{
      from_name: form.name,
      to_name: "Mohammed Alsalamat",
      from_email: form.email,
      to_email: "alslamat407@gmail.com",
